...
class TimelineMiner(object):
    def __init__(self, access_token, access_secret, consumer_key, consumer_secret, user_name):
        self.access_token = '220846580-AtrY0FBq5Yd2OcHtjm4FL5KEdf31qzjOtFMDoE4m'
        self.access_secret ='ID9RUnPxFmrMcOQNMNUwSy713CFLULNb21hKeZ57bLq4R'
        self.consumer_key = 'GwpuXi1ZMyc0ATSb3FEPaTyOU'
        self.consumer_secret = '0Y1jaPrDOa0uGsxQc4DSDphRWPPYCtVZ0TtvgZorAvzywIZtXJ'
        self.user_name = 'shideh66'
        self.auth = None
...
if __name__ == "__main__":
    ...
    parser.add_argument('-m', '--max',
                        help='Maximum number (integer) of timeline tweets query (searches all by default)')
